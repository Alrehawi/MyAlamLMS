(function($) {
	...
	layerSlider.options = {
		...
		skin				: 'defaultskin',				// You can change the skin of the Slider, use 'noskin' to hide skin and buttons.
		skinsPath			: '/stylesheets/layerslider/skins/',	// You can change the default path of the skins folder. Note, that you must use the slash at the end of the path.
