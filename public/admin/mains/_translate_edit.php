...
$session->check_permission('MainCategoryTranslate', '_manage.php');
?>
<?php
...
$parent = MainCategory::find_by_id($cur_trans->parent_id," AND site_id={$session->site_id}");
    ...
    <div class="col-lg-12">
        <div class="panel panel-default" style="border: none;">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-12">
                       <form name="main" action="_translate_edit.php?id=<?php echo $cur_trans->id; ?>" method="POST" enctype="multipart/form-data">
                         <?php echo setToken() ?>
