...
$session->check_permission('VoteQuestionTranslate', '_manage.php');
?>
<?php
...
$parent = VoteQuestion::find_by_id($cur_trans->parent_id," AND site_id={$session->site_id}");
    ...
    <div class="col-lg-12">
        <div class="panel panel-default" style="border: none;">
            <div class="panel-heading">
                <h2><?php echo read_xmls('/site/votequestion/titles/edit') ?>: <?php echo $trans_title[0]->content; ?></h2>
                <a class="btn btn-primary pull-left margin-link" href="_add.php"><?php echo read_xmls('/site/votequestion/titles/add') ?><i class="fa fa-plus margin-right-fivePx" aria-hidden="true"></i></a>
                <a class="btn btn-primary pull-left margin-link" href="_manage.php"><?php echo read_xmls('/site/votequestion/titles/manage') ?><i class="fa fa-th-list margin-right-fivePx" aria-hidden="true"></i></a>
                <a class="btn btn-info pull-left margin-link" href="_translate.php?parent=<?php echo $cur_trans->parent_id; ?>">
                    <?php echo read_xmls('/site/votequestion/lables/translate')?><i class="fa fa-language margin-right-fivePx" aria-hidden="true"></i>
                </a>
            </div>
                        ...
                        <form name="section" action="_translate_edit.php?id=<?php echo $cur_trans->id; ?>" method="POST" enctype="multipart/form-data">
                          <?php echo setToken() ?>
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="title" value="<?php echo $trans_title[0]->content; ?>" maxlength="250"/>
