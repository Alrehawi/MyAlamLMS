...
$session->check_permission('PageTranslate', '_manage.php');
?>
<?php
...
$parent = Page::find_by_id($cur_trans->parent_id," AND site_id={$session->site_id}");
...
if (isset($_POST['submit'])) {
  if(!checkToken($_POST['_token'])){
    ...
    $fields = array('title' => $title, 'content' => $content, 'keywords' => $keywords, 'description' => $description);
...
$translate_content = Translator::find_translate_by_parent_lang_type($cur_trans->parent_id, $cur_trans->item_type, 'content', $cur_trans->lang_id);
    ...
    <div class="col-lg-12">
        <div class="panel panel-default" style="border: none;">
            <div class="panel-heading">
                <h2><?php echo read_xmls('/site/page/titles/edit') ?>: <?php echo @$translate[0]->content; ?></h2>
                <a class="btn btn-primary pull-left margin-link" href="_add.php"><?php echo read_xmls('/site/page/titles/add') ?><i class="fa fa-plus margin-right-fivePx" aria-hidden="true"></i></a>
                <a class="btn btn-primary pull-left margin-link" href="_manage.php"><?php echo read_xmls('/site/page/titles/manage') ?><i class="fa fa-th-list margin-right-fivePx" aria-hidden="true"></i></a>
                <a class="btn btn-info pull-left margin-link" href="_translate.php?parent=<?php echo $cur_trans->parent_id; ?>">
                <?php echo read_xmls('/site/page/lables/translate') . ": " . $parent->title; ?><i class="fa fa-language margin-right-fivePx" aria-hidden="true"></i>
                </a>
            </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-12">
                        <form name="page" action="_translate_edit.php?id=<?php echo $cur_trans->id; ?>" method="POST" enctype="multipart/form-data">
                          <?php echo setToken() ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                    $getValue = $translate_content[0]->content;
                                    $getField = 'content';
