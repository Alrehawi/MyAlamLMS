...
$session->check_permission('AdTranslate', '_manage.php');
?>
<?php
...
$parent = Ad::find_by_id($cur_trans->parent_id);
...
$trans_content = Translator::find_translate_by_parent_lang_type($cur_trans->parent_id, $cur_trans->item_type, 'content', $cur_trans->lang_id);
?>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default" style="border: none;">
            <div  class="panel-heading">
               <h2><?php echo read_xmls('/site/ad/titles/edit') ?>: <?php echo $trans_title[0]->content; ?></h2>
               <a class="btn btn-primary pull-left margin-link" href="_add.php"><?php echo read_xmls('/site/ad/titles/add') ?><i class="fa fa-plus" aria-hidden="true"></i></a>
                <a class="btn btn-primary pull-left margin-link" href="_manage.php"><?php echo read_xmls('/site/ad/titles/manage') ?><i class="fa fa-th-list" aria-hidden="true"></i></a>
                <a class="btn btn-info pull-left margin-link" href="_translate.php?parent=<?php echo $cur_trans->parent_id; ?>">
                <?php echo read_xmls('/site/ad/lables/translate') . ": " . $parent->title; ?><i class="fa fa-language" aria-hidden="true"></i>
                </a>
            </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-12">
                        <form name="ad" action="_translate_edit.php?id=<?php echo $cur_trans->id; ?>" method="POST" enctype="multipart/form-data">
                          <?php echo setToken() ?>
                                ...
                                <div class="form-group">
                                    <label><?php echo read_xmls('/site/ad/lables/name') ?></label>
                                    <input class="form-control" type="text" name="content" value="<?php echo $trans_content[0]->content; ?>" maxlength="255">
                                </div>
